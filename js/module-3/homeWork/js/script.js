...
function isLoginUnique(allLogins, login) {
  ...
  //   for (const log of allLogins) { //переберу масив логінів і порівняю всі логіни з введенним
  // if (log === login) { // якщо введене слово вже є в масиві повернемо false в іншому випадку true
  //return false;
  //   }
  return true;
}
